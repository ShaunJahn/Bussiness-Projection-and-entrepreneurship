        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProdutBasicsUnitCosts_ProductItem_ProductId",
                        column: x => x.ProductId,
                        principalTable: "ProductItem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(nullable: true),
                    Month = table.Column<string>(nullable: true),
                    UnitOpeningStock = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stocks_ProductItem_ProductId",
                        column: x => x.ProductId,
                        principalTable: "ProductItem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_totalCostOfProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_totalCostOfProducts_ProductItem_ProductId",
                        column: x => x.ProductId,
                        principalTable: "ProductItem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProdutBasicsUnitCosts_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_totalCostOfProducts_ProductId",
                table: "totalCostOfProducts",
                column: "ProductId");
        }
